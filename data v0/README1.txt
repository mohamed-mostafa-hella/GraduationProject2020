...
5. Two drivers with more than 15 years of driving experience executed the driving events; 
...
-> Acceleration ->accelerometer -> linear file and other non-liner file -> 2 file.
...
-> Magnetometer -> مقياس شده المجال المغناطيسي
...
The following fields are common in the files:
...
The following work used this data set:
